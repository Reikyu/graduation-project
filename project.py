...
try:
    while True:
        ...
        img_result = cv2.bitwise_and(bg_removed, bg_removed, mask=img_mask)
        ...
        for idx, centroids in enumerate(centroids):
            ...
            if area > 10:
                ...
                cv2.putText(bg_removed, str(C), (int(centerX), int(centerY)), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 2)
                cv2.putText(bg_removed, str(dist), (int(centerX), int(centerY) + 30), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 2)
